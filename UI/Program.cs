    ...
    private static void CrearPedido()
{
    ...
    _pedidoService.CargarPDeLista(pedido,_productoService.CargarProductos(pedido));
    ...
    private static void ConsultarPedido()
{
    ...
    if (pedido != null)
    {
        ...
        Console.WriteLine($"Productos: {_pedidoService.MostrarProductos}");
    ...
    private static void ListarPedidos()
{
    ...
    {
        Console.WriteLine($"ID: {pedido.Id} - ID del Cliente: {pedido.ClienteId} - ID del Producto: ");
        _pedidoService.MostrarProductos(pedido.Id);
        Console.WriteLine($" - Cantidad: {pedido.Cantidad} - Fecha: {pedido.Fecha}");
    }
    Console.WriteLine("Presione una tecla para continuar.");
    Console.ReadKey();
}
